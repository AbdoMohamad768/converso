...
function CompanionComponent({
  ...
  const [isSpeeking, setIsSpeeking] = useState<true | false>(false);
  ...
  useEffect(
    function () {
      ...
      if (isSpeeking) lottieRef.current?.play();
        ...
        <div className="user-section">
          ...
          >
            <Image
              ...
              height={36}
            />
            <p className="max-sm:hidden">{isMuted ? "Turn on" : "Turn off"}</p>
          </button>
          <button
            className={cn(
              "rounded-lg cursor-pointer transition-colors py-2 w-full text-white",
